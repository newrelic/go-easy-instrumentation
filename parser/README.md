...
2. Always cover new instrumentation with [validation tests](/validation-tests/README.md). These are the most robust way to catch edge cases, and are a non-negotiable requirement for every feature added.
