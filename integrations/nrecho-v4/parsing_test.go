...
import (
	...
	nrecho "github.com/newrelic/go-easy-instrumentation/integrations/nrecho-v4"
...
func txnAssignStmtV4(txnVar, ctxName string) *dst.AssignStmt {
...
func TestDefineTxnFromEchoCtx(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			ctxName:     "c",
			want: &dst.BlockStmt{
				List: []dst.Stmt{txnAssignStmtV4("nrTxn", "c"), doSomething},
			},
		},
		{
			...
			ctxName:     "c",
			want: &dst.BlockStmt{
				List: []dst.Stmt{txnAssignStmtV4("nrTxn", "c")},
			},
		},
		{
			...
			ctxName:     "c",
			want: &dst.BlockStmt{
				List: []dst.Stmt{txnAssignStmtV4("nrTxn", "c"), doSomething, doOther},
			},
		},
	}
